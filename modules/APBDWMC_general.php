<?php
	...
	class APBDWMC_general extends AppsBDLiteModule{
		...
		function OnInit() {
			parent::OnInit();
			$this->AddAdminAjaxAction("add",[$this,"newCurrency"]);
			$this->AddAdminAjaxAction("set-default",[$this,"SetDefaultCurrency"]);
			$this->AddAdminAjaxAction("delete-currency",[$this,"DeleteCurrency"]);
			$this->AddAdminAjaxAction("get-rate",[$this,"GetRate"]);
			$this->AddAdminAjaxAction("update",[$this,"UpdateCurrency"]);
			$this->AddAdminAjaxAction("update-all",[$this,"UpdateAllRateCurrency"]);
            $this->SetCurrency();
